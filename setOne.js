...
const implicit = (param1, param2) => console.log(`The first parameter is ${param1}. The second parameter is ${param2}`)
...
greeting('Phillip', 'Avila', (fullName) => console.log(`Hello, my full name is ${fullName}`))
...
pricesPlusTax([3, 4, 5], (totalCost) => console.log(`The new array plus tax = ${totalCost}`))
